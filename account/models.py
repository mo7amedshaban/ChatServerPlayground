...
class MyAccountManager(BaseUserManager):
    def create_user(self, email, username, password=None):
        ...
        user = self.model(
            email=self.normalize_email(email),  # normalize_email  ---> for lower case
            username=username,
        )
...
# pip install pillow     package for image store ,upload_to
class Account(AbstractBaseUser):
    ...
    # use it in .html    src="{{ request.user.profile_image.url }}"
